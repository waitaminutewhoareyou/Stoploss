...
ret_dir = './data/' + 'consolidated_table_wo_features_SP'
...
class StopLossPrimer:
    ...
    def stoploss_detect(self, daily_data, num_shocks=3):
        ...
        sl_indicator = daily_data / look_back_data.std() <= -num_shocks
        ...
        sl_cum_indicator = current_week_cum_ret / look_back_data.std() <= -np.sqrt(
...
if __name__ == '__main__':
    ...
    plt.show()
    print(pd.concat(result, axis=1).round(2).to_markdown())
